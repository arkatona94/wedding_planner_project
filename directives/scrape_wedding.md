...
## Inputs
- **Industry**: The target industry (e.g., "Venues", "Entertainment", "Weddings", "Vendors").
- **Location**: The target location (e.g., "Cincinnati, Ohio", "United States").
- **Total Count**: The total number of leads desired.

## Tools/Scripts
- Script: `execution/scrape_apify.py` (single scrape, for <100 leads)
